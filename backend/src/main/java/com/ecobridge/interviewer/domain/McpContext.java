...
public class McpContext extends Auditable {
  ...
  // ------------------------------------------------------------
  public static McpContext start(InterviewSession session, Phase phase, Question question) {
  ...
  public void append(Phase phase, Question question) {
    List<Map<String, Object>> history =
        (List<Map<String, Object>>) state.computeIfAbsent("history", k -> new ArrayList<>());
